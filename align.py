...
str = ''.join(list)
process2=subprocess.call(['python3','textgrid2csv.py','-o','outputcsv/output.csv',str])
if process2 != 0:
    raise RuntimeError("unable to do conversion from TextGrid to CSV")
list1 = glob.glob("outputcsv/*.csv")
str2 = ''.join(list1)
process3=subprocess.call(['python3','csv2json.py','-i',str2,'-o','outputjson/output.json'])
if process3 != 0:
